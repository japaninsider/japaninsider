...
const translations = {
  en: {
    "meta.title":"Japan Insider — Personal Travel Planning & Concierge",
    ...
    "pricing.eyebrow":"CHOOSE YOUR PLAN","pricing.title":"Start small. Upgrade when you need more.","pricing.intro":"USD prices are reference prices. Actual sale prices and checkout are in EUR, and the exact EUR amount is shown before payment.",
  ...
  ja: {
    "meta.title":"Japan Insider — あなただけの日本旅行プラン＆コンシェルジュ",
    ...
    "pricing.eyebrow":"料金プラン","pricing.title":"まずは小さく。必要に応じてアップグレード。","pricing.intro":"サイト上のUSD表示は参考価格です。実際の販売価格・決済はEUR建てで、決済前に正確なEUR金額を表示します。",
    ...
    "pricing.premium_1":"Personal Planの全内容","pricing.premium_2":"7日間の旅行チャットサポート","pricing.premium_3":"追加リサーチ＆最新情報","pricing.choose_premium":"Premiumを選ぶ",
    "pricing.vip_kicker":"VIP","pricing.vip_title":"Japan VIP","pricing.vip_sub":"ハイタッチ・コンシェルジュ","pricing.vip_1":"完全カスタマイズのサポート","pricing.vip_2":"優先リサーチ","pricing.vip_3":"旅の内容に合わせて個別設計","pricing.contact":"問い合わせる",
    ...
    "about.b3_title":"時間を節約","about.b3_text":"旅行のための検索時間を減らし、楽しむ時間を増やします。","about.b4_title":"人によるサポート","about.b4_text":"検索だけでは解決しないことを、人に相談できます。",
    "faq.title":"ご予約前によくいただく質問。","faq.q1":"Japan Insiderは旅行会社ですか？","faq.a1":"いいえ。現在のサービスは旅行リサーチ、相談、情報提供、コンシェルジュ型サポートが中心です。パッケージ旅行、交通、宿泊の販売は行いません。",
    "faq.q2":"レストランやホテルの予約もしてくれますか？","faq.a2":"候補のリサーチや予約方法のご案内は可能です。実際の予約代行は、事業者や現地ルール、サービス範囲によって制限される場合があります。",
  ...
  es: {
    ...
    "pricing.eyebrow":"ELIGE TU PLAN","pricing.title":"Empieza por lo esencial. Amplía cuando lo necesites.","pricing.intro":"Los precios en USD son orientativos. El precio real de venta y el pago se realizan en EUR, y el importe exacto en EUR se muestra antes de pagar.",
