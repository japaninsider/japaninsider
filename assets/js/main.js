...
const translations = {
  en: {
    "meta.title":"Japan Insider — Japan Travel Advice by Masayasu Wakihama",
    "nav.services":"Services","nav.pricing":"Pricing","nav.how":"How it works","nav.about":"About","nav.faq":"FAQ","nav.start":"Get started",
    "hero.eyebrow":"PERSONAL JAPAN TRAVEL, RESEARCHED FOR YOU",
    "hero.title_html":"Your Japan.<br><span>Better planned.</span>",
    ...
    "stats.research":"Personal research","stats.tiers":"Simple service tiers","stats.currency":"USD","stats.pricing":"Clear pricing","stats.local":"Local perspective",
    ...
    "services.concierge_title":"Research support","services.concierge_text":"Extra help before and during your trip for questions, fresh research and practical guidance. You make all third-party bookings and payments directly.",
    "quickfirst.eyebrow":"START SMALL","quickfirst.title":"Ask up to 3 Japan travel questions.","quickfirst.body_html":"Individually researched by a Japan-based hospitality professional. <strong>$49 USD</strong> · Target reply within 2 business days after we receive the information needed to begin.","quickfirst.cta":"Request Quick Help — $49",
    ...
    "pricing.popular":"PLAN + DURING-TRIP SUPPORT","pricing.premium_kicker":"PREMIUM","pricing.premium_title":"Japan Premium","pricing.premium_sub":"Plan + during-trip email support",
    ...
    "pricing.vip_kicker":"VIP","pricing.vip_title":"Japan VIP","pricing.vip_sub":"Custom travel advisory","pricing.vip_1":"Fully customized support","pricing.vip_2":"Priority research","pricing.vip_3":"Scope built around your trip","pricing.contact":"Contact us",
    "common.get_started":"Get started",
    "pricing.legal":"Japan Insider provides research, comparisons, information, recommendations and booking guidance. Customers book, contract and pay hotels, transport, restaurants and other third parties directly.",
    "how.eyebrow":"HOW IT WORKS","how.title":"Four easy steps.","how.step1_title":"Tell us your trip","how.step1_text":"Share your dates, travelers, interests, budget and what you want help with.",
    "how.step2_title":"We research","how.step2_text":"We filter the noise and focus on options that actually fit you.","how.step3_title":"You receive your plan","how.step3_text":"Get clear recommendations you can use immediately.",
    "how.step4_title":"We stay available","how.step4_text":"Premium and VIP clients can add support around the trip itself.",
    "about.eyebrow":"WHY JAPAN INSIDER","about.title":"Useful local context, without the cookie-cutter tour.","about.text":"Japan is easy to admire and surprisingly time-consuming to plan well. Japan Insider exists to make the research lighter and the experience more personal.",
    ...
    "about.b3_title":"Time saved","about.b3_text":"Spend less of your holiday planning your holiday.","about.b4_title":"Human support","about.b4_text":"Ask a real person when search results are not enough.","about.public_record":"Public InterContinental hospitality record (2020) ↗",
    "faq.title":"Good questions before you book.","faq.q1":"Is Japan Insider a travel agency?","faq.a1":"No. Japan Insider provides travel research, consultation, information and advisory support. We do not sell package travel, transportation or accommodation, and we do not make third-party bookings on your behalf.",
    ...
    "footer.desc":"Personal Japan travel research & advisory support.","footer.explore":"Explore","footer.info":"Info","footer.project":"Project","footer.privacy":"Privacy","footer.terms":"Terms","footer.legal":"Legal / Commerce disclosure","footer.contact":"Contact","footer.tagline":"Your Japan, Better.","footer.built":"Built for GitHub Pages.",
  ...
  ja: {
    "meta.title":"Japan Insider — Masayasu Wakihamaの日本旅行アドバイス",
    "nav.services":"サービス","nav.pricing":"料金","nav.how":"ご利用の流れ","nav.about":"私たちについて","nav.faq":"よくある質問","nav.start":"相談する",
    "hero.eyebrow":"あなたのために調べる、パーソナルな日本旅行",
    "hero.title_html":"あなたの日本を、<br><span>もっとあなたらしく。</span>",
    ...
    "stats.research":"1対1の個別リサーチ","stats.tiers":"わかりやすい4プラン","stats.currency":"USD","stats.pricing":"料金（USD）","stats.local":"日本からの現地目線",
    ...
    "services.concierge_title":"リサーチサポート","services.concierge_text":"旅行前・旅行中の質問、追加リサーチ、実用的な情報収集をサポートします。第三者サービスの予約・契約・支払いはお客様ご自身で行っていただきます。",
    ...
    "pricing.popular":"プラン＋旅行中メールサポート","pricing.premium_kicker":"プレミアム","pricing.premium_title":"Japan Premium｜旅行プラン＋サポート","pricing.premium_sub":"旅行プラン＋旅行中メールサポート",
    ...
    "pricing.vip_kicker":"VIP","pricing.vip_title":"Japan VIP｜カスタム旅行アドバイス","pricing.vip_sub":"高い個別性の旅行アドバイス","pricing.vip_1":"完全カスタマイズのサポート","pricing.vip_2":"優先リサーチ","pricing.vip_3":"旅の内容に合わせて個別設計","pricing.contact":"問い合わせる",
    "common.get_started":"相談する",
    "pricing.legal":"Japan Insiderは調査、比較、情報提供、おすすめの提案、予約方法の案内を行います。ホテル、交通、飲食店その他の第三者サービスの予約・契約・支払いは、お客様ご自身で直接行っていただきます。",
    "how.eyebrow":"ご利用の流れ","how.title":"かんたん4ステップ。","how.step1_title":"旅について教えてください","how.step1_text":"日程、人数、興味、予算、困っていることを共有してください。",
    "how.step2_title":"私たちがリサーチ","how.step2_text":"大量の情報から、あなたに本当に合う選択肢を絞り込みます。",
    "how.step3_title":"プランをお届け","how.step3_text":"すぐに使える、わかりやすいおすすめ情報をまとめてお届けします。",
    "how.step4_title":"必要に応じて継続サポート","how.step4_text":"Premium・VIPでは旅行前後や旅行中の追加サポートも利用できます。",
    "about.eyebrow":"WHY JAPAN INSIDER","about.title":"定番ツアーでは得にくい、役立つ現地目線を。","about.text":"日本は魅力的な一方、上手に旅を組み立てようとすると意外と調べることが多い国です。Japan Insiderは、そのリサーチを軽くし、旅をもっとパーソナルにするためのサービスです。",
    "about.b1_title":"現地目線","about.b1_text":"日本で実際に役立つ情報をベースにリサーチします。","about.b2_title":"完全パーソナル","about.b2_text":"テンプレートではなく、あなたの旅に合わせて提案します。",
    "about.b3_title":"時間を節約","about.b3_text":"旅行のための検索時間を減らし、楽しむ時間を増やします。","about.b4_title":"人によるサポート","about.b4_text":"検索だけでは解決しないことを、人に相談できます。","about.public_record":"InterContinentalでの公開ホスピタリティ記録（2020年）↗",
    "faq.title":"ご予約前によくいただく質問。","faq.q1":"Japan Insiderは旅行会社ですか？","faq.a1":"いいえ。Japan Insiderは旅行リサーチ、相談、情報提供、アドバイスを提供します。パッケージ旅行、交通、宿泊の販売や、お客様に代わる第三者サービスの予約は行いません。",
    "faq.q2":"レストランやホテルの予約もしてくれますか？","faq.a2":"候補を調査し、予約方法をご案内します。ホテル、交通、飲食店その他の第三者サービスの予約・契約・支払いは、お客様ご自身で各事業者に直接行っていただきます。",
    ...
    "form.name":"お名前","form.email":"メールアドレス","form.plan":"興味のあるプラン","form.message":"旅行について教えてください","form.submit":"問い合わせを送信","form.unsure":"まだ決めていない",
    "form.name_ph":"お名前","form.email_ph":"you@example.com","form.message_ph":"日程、都市、人数、興味、予算、相談したいことなど...",
    "footer.desc":"日本旅行のパーソナルリサーチ＆アドバイス。","footer.explore":"メニュー","footer.info":"情報","footer.project":"プロジェクト","footer.privacy":"プライバシー","footer.terms":"利用規約","footer.legal":"特定商取引法に基づく表記","footer.contact":"お問い合わせ","footer.tagline":"あなたの日本旅行を、もっと良く。","footer.built":"GitHub Pagesで公開できます。",
  ...
  es: {
    ...
    "stats.research":"Investigación personal","stats.tiers":"Planes sencillos","stats.currency":"USD","stats.pricing":"Precios en USD","stats.local":"Perspectiva local",
    ...
    "contact.note_html":"Las consultas se envían a <strong>infojapaninsider@gmail.com</strong>.",
...
const displayPrices = {
  ...
  es: { quick: "$49", personal: "$199", premium: "$499", vip: "$999+" }
};
...
function applyLanguage(lang){
  ...
  document.querySelectorAll("[data-i18n-html]").forEach(el => {
    ...
    el.innerHTML = translations[lang][key] ?? translations.en[key] ?? el.innerHTML;
  });
...
(function(){
 const copy={
  en:{
   ...
   vip:"High-touch custom planning · One-time payment",
   sample:"See sample →"
  },
  ja:{
...
(function(){
 const T={
  ...
  ja:{
   ...
   aboutTitle:"5つ星ホテル、記者経験、ロサンゼルス10年。3つの経験を、あなたの日本旅行に。",
...
(function(){
 const T={
  en:{
   ...
   quickFlowBody:"Send request → We confirm the next step and payment → Send up to 3 questions → Receive your researched answer by email, usually within 2 business days after the information needed to begin is received."
  },
  ja:{
   footerIntake:"お申し込みフォーム",
   contactPrompt:"旅行について教えてください",
   quickFlowTitle:"Quick Helpの流れ",
   quickFlowBody:"依頼を送信 → お支払いと次の手順を確認 → 最大3つの質問を送信 → 必要情報の受領後、通常2営業日以内を目安にメールで回答。"
  },
  es:{
...
(function(){
 ...
 function lang(){const l=localStorage.getItem("japanInsiderLang")||document.documentElement.lang||"en";return ["en","ja"].includes(l)?l:"en";}
