...
const translations = {
  en: {
    ...
    "pricing.eyebrow":"CHOOSE YOUR PLAN","pricing.title":"Start small. Upgrade when you need more.","pricing.intro":"Prices are shown in USD. Actual checkout is processed in EUR. Final scope is confirmed before payment.",
  ...
  ja: {
    ...
    "pricing.eyebrow":"料金プラン","pricing.title":"まずは小さく。必要に応じてアップグレード。","pricing.intro":"料金表示は米ドル（USD）を基準にしています。実際の決済はユーロ（EUR）で行われます。お支払い前にサービス範囲を確認します。",
  ...
  es: {
    ...
    "pricing.eyebrow":"ELIGE TU PLAN","pricing.title":"Empieza por lo esencial. Amplía cuando lo necesites.","pricing.intro":"Los precios se muestran en dólares estadounidenses (USD). El pago real se procesa en euros (EUR) y el alcance final se confirma antes del pago.",
