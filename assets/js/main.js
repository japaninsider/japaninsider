...
const translations = {
  en: {
    ...
    "pricing.eyebrow":"CHOOSE YOUR PLAN","pricing.title":"Start small. Upgrade when you need more.","pricing.intro":"Simple USD pricing for international travelers. Final scope is confirmed before payment.",
  ...
  ja: {
    ...
    "pricing.eyebrow":"料金プラン","pricing.title":"まずは小さく。必要に応じてアップグレード。","pricing.intro":"海外のお客様にもわかりやすいUSD料金。お支払い前にサービス範囲を確認します。",
